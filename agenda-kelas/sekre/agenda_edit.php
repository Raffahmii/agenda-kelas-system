...
$page_subtitle = 'Ubah data agenda kelas';
...
$stmt = $pdo->prepare("SELECT * FROM agenda WHERE id = ? AND dibuat_oleh = ?");
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($judul)) {
        ...
        $update = $pdo->prepare("
            UPDATE agenda 
            SET judul = ?, deskripsi = ?, tanggal = ? 
            WHERE id = ? AND dibuat_oleh = ?
        ");
        
        if ($update->execute([$judul, $deskripsi, $tanggal, $id, $userId])) {
            ...
            <form method="POST">
                <div class="form-group">
                    ...
                    <div class="input-icon">
                        ...
                        <input type="text" name="judul" value="<?php echo htmlspecialchars($agenda['judul']); ?>" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-icon">
                        ...
                        <textarea name="deskripsi" rows="5" placeholder="Masukkan deskripsi agenda (opsional)"><?php echo htmlspecialchars($agenda['deskripsi'] ?? ''); ?></textarea>
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <div class="input-icon">
                            ...
                            <input type="date" name="tanggal" value="<?php echo $agenda['tanggal']; ?>" required>
                        </div>
                    </div>
                </div>
